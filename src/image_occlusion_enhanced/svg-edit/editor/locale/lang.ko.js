svgEditor.readLang({
	...
	ui: {
		"toggle_stroke_tools": "더 많은 획 도수 표시/숨김",
		"palette_info": "채우기 색상을 변경하려면 클릭하고 획 색상을 변경하려면 Shift 키를 누른 상태에서 클릭하십시오.",
		"zoom_level": "확대/축소 수준을 변경하시오.",
		"panel_drag": "왼쪽/오른쪽으로 드래그하여 측면 패널 크기 조정하시오."
	},
	properties: {
		"id": "Identify the element",
		"fill_color": "채우기 색상 변경",
		"stroke_color": "선 색상 변경",
		"stroke_style": "점선 스타일 변경",
		"stroke_width": "선 너비를 1씩 변경하고 Shift 키를 누른 상태에서 클릭하면 0.1씩 변경됩니다.",
		"pos_x": "X 좌표 변경",
		"pos_y": "Y 좌표 변경",
		...
		"angle": "회전 각도 변경",
		"blur": "가우시안 블루 값 변경",
		"opacity": "선택된 항목의 불투명도 변경",
		"circle_cx": "원의 중심의 X 좌표 변경",
		"circle_cy": "원의 중심의 Y 좌표 변경",
		"circle_r": "원의 반지름 변경",
		"ellipse_cx": "타원의 중심의CX는 타원의 좌표 변경",
